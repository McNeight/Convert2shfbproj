...
// project's Visibility category properties.
//
...
// 1.9.9.0  12/05/2013  EFW  Updated the methods for use by plug-ins that need to remove members from reflection
//                           files generated by some other means.
//===============================================================================================================
...
namespace SandcastleBuilder.Utils.BuildEngine
{
    partial class BuildProcess
    {
        ...
        public void ApplyVisibilityProperties(string reflectionInfoFile)
        {
            ...
            this.ReportProgress("Applying visibility properties to reflection information file");
        ...
        private void RemoveExplicitInterfaceImplementations(XmlNode apisRoot)
        {
            ...
            try
            {
                ...
                this.ReportProgress("    {0} explicit interface implementations removed", elements.Count);
                ...
                this.ReportProgress("    {0} local and base class EII elements removed", elements.Count);
            }
            catch(Exception ex)
            {
        ...
        private void ModifyProtectedInternalVisibility(XmlNode apisRoot)
        {
            ...
            try
            {
                ...
                this.ReportProgress("    {0} 'protected internal' members changed to 'protected'", members.Count);
            }
            catch(Exception ex)
            {
        ...
        private void RemoveSealedProtected(XmlNode apisRoot)
        {
            ...
            try
            {
                ...
                this.ReportProgress("    {0} protected members removed from sealed classes", removed);
            }
            catch(Exception ex)
            {
