...
namespace SandcastleBuilder.Utils.Conversion
{
    ...
    public class ConvertFromSandcastleGui : ConvertToMSBuildFormat
    {
        ...
        /// <inheritdoc />
        public ConvertFromSandcastleGui(string oldProjectFile, string folder) : base(oldProjectFile, folder)
        {
        }

        /// <inheritdoc />
        public ConvertFromSandcastleGui(string oldProjectFile, SandcastleProject newProject) :
