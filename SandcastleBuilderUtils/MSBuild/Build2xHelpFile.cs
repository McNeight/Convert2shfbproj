...
//
// This file contains the MSBuild task used to run HXCOMP.EXE which is used to compile a Help 2 (HxS) help file
//
...
// 1.9.6.0  11/28/2012  EFW  Added the -i command line option to suppress informational messages
//===============================================================================================================
...
namespace SandcastleBuilder.Utils.MSBuild
{
    ...
    public class Build2xHelpFile : ToolTask
    {
        ...
        {
            return String.Format(CultureInfo.InvariantCulture, "-p \"{0}.HxC\" -l \"{0}.log\" -i",
                this.HtmlHelpName);
        }
        ...
        /// </summary>
        /// <returns>True on success, false on failure.  HXCOMP returns 0 on success, 1 if warnings were issued
