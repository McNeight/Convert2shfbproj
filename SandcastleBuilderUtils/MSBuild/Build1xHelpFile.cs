...
namespace SandcastleBuilder.Utils.MSBuild
{
    ...
    public class Build1xHelpFile : ToolTask
    {
        ...
        private string workingFolder, helpCompilerFolder, helpProjectName, localizeApp;
        private int langId;
        #endregion
        ...
        protected override bool ValidateParameters()
        {
            ...
            if(String.IsNullOrEmpty(helpProjectName) || !File.Exists(helpProjectName))
            {
        ...
        protected override string GenerateCommandLineCommands()
        {
            if(!String.IsNullOrEmpty(localizeApp))
            {
                ...
                return String.Format(CultureInfo.InvariantCulture, "{0} \"{1}\" \"{2}\"", langId,
                    Path.Combine(helpCompilerFolder, HelpCompilerName), helpProjectName);
            }
        ...
        public override bool Execute()
        {
            ...
            if(base.Execute() && base.ExitCode == 0 && String.IsNullOrEmpty(localizeApp))
